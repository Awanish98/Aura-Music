...
"KWuyx6yZ21U",
  ...
  var currentTrackQueue = [];
    ...
    var sbBadge = $('sidebarVibeSpeedBadge');
    var sbSub = $('sidebarVibeSpeedSub');
    if (currentSpeedMode === '1.25') {
      if (btn) btn.textContent = '1.25x ⚡';
      if (sbBadge) { sbBadge.textContent = '1.25x ⚡'; sbBadge.style.background = '#f59e0b'; sbBadge.style.color = '#000'; }
      if (sbSub) sbSub.textContent = '⚡ Nightcore / Speed Up Active';
    } else if (currentSpeedMode === '0.85') {
      if (btn) btn.textContent = '0.85x 🌙';
      if (sbBadge) { sbBadge.textContent = '0.85x 🌙'; sbBadge.style.background = '#a855f7'; sbBadge.style.color = '#fff'; }
      if (sbSub) sbSub.textContent = '🌙 Slowed + Reverb Chill Active';
    } else {
      if (btn) btn.textContent = '1.0x';
      if (sbBadge) { sbBadge.textContent = '1.0x'; sbBadge.style.background = 'rgba(255,255,255,0.15)'; sbBadge.style.color = '#fff'; }
      if (sbSub) sbSub.textContent = '1.0x Normal · 1.25x Nightcore · 0.85x Slowed';
    }
  }
  ...
  var JamRoomEngine = (function () {
    ...
    function openRoomModal() {
      ...
      if (modal) {
        modal.classList.add('open');
        showToast('🎧 Jam Room Open — Sync with Friends');
      }
    }
  ...
  var MoodUniverseEngine = (function () {
    ...
    var MOOD_STATIONS = [
      ...
      // --- ARTIST STATIONS ---
      {
        ...
        category: 'artist',
        energy: '💔 Soul King',
        desc: 'Every heartbeat song by the voice that owns Bollywood — Arijit Singh hits non-stop',
        tags: ['#Arijit', '#ArijitSingh', '#BollywoodSoul', '#CryCore'],
        accent: '#f97316',
        accentGlow: 'rgba(249, 115, 22, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(249, 115, 22, 0.22) 0%, rgba(234, 88, 12, 0.08) 100%)',
        quote: '"Tum Hi Ho — ek awaaz jo seedha dil mein utarti hai…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '✨ Nightingale',
        desc: 'The queen of melody — Shreya Ghoshal magical voice in every language',
        tags: ['#Shreya', '#GhoshalVibes', '#Melody', '#BollyQueen'],
        accent: '#f43f5e',
        accentGlow: 'rgba(244, 63, 94, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(244, 63, 94, 0.22) 0%, rgba(225, 29, 72, 0.08) 100%)',
        quote: '"Teri meri prem kahani…" — a voice that turns silence into poetry.',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🔥 Brown Munde',
        desc: 'Gen Z Punjabi vibes — AP Dhillon coolest tracks that hit different every time',
        tags: ['#APDhillon', '#PunjabiPop', '#Desi', '#BrownMunde'],
        accent: '#7c3aed',
        accentGlow: 'rgba(124, 58, 237, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(124, 58, 237, 0.22) 0%, rgba(109, 40, 217, 0.08) 100%)',
        quote: '"Excuses pe excuses — par dil mera tujhpe hi tika raha…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🎉 Party Boss',
        desc: 'Non-stop Badshah bangers — Genda Phool to Paagal, every track is a vibe',
        tags: ['#Badshah', '#HipHop', '#Party', '#Banger'],
        accent: '#eab308',
        accentGlow: 'rgba(234, 179, 8, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(234, 179, 8, 0.22) 0%, rgba(202, 138, 4, 0.08) 100%)',
        quote: '"Paagal nahi tha main, par ho gaya tera — Badshah style!"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💛 Fearless',
        desc: 'Every era from Taylor — folklore cottage to 1989 synths to Anti-Hero anthems',
        tags: ['#TaylorSwift', '#Swifties', '#Eras', '#PopPrincess'],
        accent: '#f59e0b',
        accentGlow: 'rgba(245, 158, 11, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(245, 158, 11, 0.22) 0%, rgba(217, 119, 6, 0.08) 100%)',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🌃 Dark R&B',
        desc: 'Blinding Lights to Starboy — The Weeknd midnight drama energy',
        tags: ['#TheWeeknd', '#DarkRnB', '#AfterHours', '#Starboy'],
        accent: '#dc2626',
        accentGlow: 'rgba(220, 38, 38, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(220, 38, 38, 0.22) 0%, rgba(185, 28, 28, 0.08) 100%)',
      ...
      },
      {
        ...
        icon: '🦁',
        category: 'artist',
        energy: '💪 Punjab Da Puttar',
        desc: 'Diljit ke evergreen hits — G.O.A.T to Lover, Proper Patola to Ikk Kudi',
        tags: ['#Diljit', '#DiljitDosanjh', '#GOAT', '#Lover'],
        accent: '#16a34a',
        accentGlow: 'rgba(22, 163, 74, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(22, 163, 74, 0.22) 0%, rgba(21, 128, 61, 0.08) 100%)',
        quote: '"Lover — haan main tera lover hun!"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💙 Aadat',
        desc: 'The voice of Pakistan — Atif Aslam soul-destroying romantic hits',
        tags: ['#AtifAslam', '#Aadat', '#PakistanVibes', '#BollyPak'],
        accent: '#2563eb',
        accentGlow: 'rgba(37, 99, 235, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(37, 99, 235, 0.22) 0%, rgba(29, 78, 216, 0.08) 100%)',
        quote: '"Aadat ho gayi hai tujhe bhoolne ki aadat…"',
      ...
      },
      {
        ...
        icon: '🎙️',
        category: 'artist',
        energy: '🕰️ Timeless Legend',
        desc: 'The greatest voice in Hindi cinema — Kishore Kumar evergreen classics',
        tags: ['#KishoreKumar', '#ClassicBollywood', '#Timeless', '#Legend'],
        accent: '#a16207',
        accentGlow: 'rgba(161, 98, 7, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(161, 98, 7, 0.22) 0%, rgba(133, 77, 14, 0.08) 100%)',
        quote: '"Roop tera mastana… pyar mera diwana…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💔 295 Legend',
        desc: 'The legend lives forever — SYL, 295, Jatt Da Muqabla and the legacy of Moosewala',
        tags: ['#SidhuMoosewala', '#295', '#SYL', '#Legend', '#Legend295'],
        accent: '#64748b',
        accentGlow: 'rgba(100, 116, 139, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(100, 116, 139, 0.22) 0%, rgba(71, 85, 105, 0.08) 100%)',
        quote: '"Jatta aa gaya 295 — na rok sakda mujhe koi…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💫 Young Soul',
        desc: 'Bollywood youngest sensation — Armaan Malik breezy pop & romance hits',
        tags: ['#AarmaanMalik', '#BollywoodPop', '#YoungVibes', '#SoulPop'],
        accent: '#0ea5e9',
        accentGlow: 'rgba(14, 165, 233, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(14, 165, 233, 0.22) 0%, rgba(2, 132, 199, 0.08) 100%)',
        quote: '"Main hoon hero tera…"',
      ...
      },
      {
        ...
        icon: '🕊️',
        category: 'artist',
        energy: '💙 Immortal Voice',
        desc: 'KK immortal classics — Pal, Yaaron, Tu Hi Meri Shab Hai. Gone but never forgotten.',
        tags: ['#KK', '#Pal', '#Yaaron', '#Immortal', '#KKlives'],
        accent: '#6366f1',
        accentGlow: 'rgba(99, 102, 241, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(99, 102, 241, 0.22) 0%, rgba(79, 70, 229, 0.08) 100%)',
        quote: '"Pal — yeh jo pal hai jee lo inhe…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🌃 OVO Sound',
        desc: 'God\'s Plan to One Dance — Drake\'s melodic trap bangers non-stop',
        tags: ['#Drake', '#OVO', '#GodsPlan', '#Champagne', '#TorontoDon'],
        accent: '#f59e0b',
        accentGlow: 'rgba(245, 158, 11, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(245, 158, 11, 0.22) 0%, rgba(217, 119, 6, 0.08) 100%)',
        quote: '"God\'s plan, God\'s plan — I hold back, sometimes I won\'t."',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🌸 Divine Voice',
        desc: 'Bharat Ratna Lata Didi — India ka kohinoor, timeless classics forever',
        tags: ['#Lata', '#LataMangeshkar', '#BharatRatna', '#Divine', '#Immortal'],
        accent: '#ec4899',
        accentGlow: 'rgba(236, 72, 153, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(236, 72, 153, 0.22) 0%, rgba(219, 39, 119, 0.08) 100%)',
        quote: '"Lag ja gale ki phir ye hasin raat ho na ho…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🌙 Sufi Royalty',
        desc: 'Afreen Afreen, Tere Mast Mast Do Nain — Rahat sahib divine sufi soul',
        tags: ['#Rahat', '#FatehAliKhan', '#Sufi', '#Qawwali', '#Afreen'],
        accent: '#10b981',
        accentGlow: 'rgba(16, 185, 129, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(16, 185, 129, 0.22) 0%, rgba(5, 150, 105, 0.08) 100%)',
        quote: '"Afreen afreen — rooh ko chhoo gaya hai yeh nagma…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '⚡ Bass King',
        desc: 'Desi EDM at its finest — Nucleya heavy bass drops and raw Indian fusion',
        tags: ['#Nucleya', '#DesiEDM', '#Bass', '#BassKing', '#Fusion'],
        accent: '#ef4444',
        accentGlow: 'rgba(239, 68, 68, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(239, 68, 68, 0.22) 0%, rgba(220, 38, 38, 0.08) 100%)',
        quote: '"Bass ho toh Nucleya jaisi — dhamakedaar!"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🎉 Party Queen',
        desc: 'O Humsafar to Dilbar — Neha Kakkar pop anthems for every mood and party',
        tags: ['#NehaKakkar', '#Dilbar', '#OHumsafar', '#PopQueen'],
        accent: '#f472b6',
        accentGlow: 'rgba(244, 114, 182, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(244, 114, 182, 0.22) 0%, rgba(236, 72, 153, 0.08) 100%)',
        quote: '"Tenu leke main javanga — Neha style!"',
      ...
      },
      {
        ...
        icon: '🎸',
        category: 'artist',
        energy: '☀️ Chill Indie',
        desc: 'Baaki Sab Theek Hai to Fursat — Arjun Kanungo laid-back indie pop vibes',
        tags: ['#ArjunKanungo', '#IndiePop', '#Chill', '#Fursat'],
        accent: '#f59e0b',
        accentGlow: 'rgba(245, 158, 11, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(245, 158, 11, 0.22) 0%, rgba(217, 119, 6, 0.08) 100%)',
        quote: '"Baaki sab theek hai — teri kami kuch aur hi hai…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💥 Suit Suit',
        desc: 'Suit Suit to High Rated Gabru — Guru Randhawa non-stop Punjabi pop party',
        tags: ['#GuruRandhawa', '#SuitSuit', '#HighRatedGabru', '#PunjabiPop'],
        accent: '#f97316',
        accentGlow: 'rgba(249, 115, 22, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(249, 115, 22, 0.22) 0%, rgba(234, 88, 12, 0.08) 100%)',
        quote: '"High rated gabru — party nonstop…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '💚 Shape of You',
        desc: 'Shape of You, Perfect, Bad Habits — Ed Sheeran complete discography vibes',
        tags: ['#EdSheeran', '#ShapeOfYou', '#Perfect', '#BadHabits'],
        accent: '#f59e0b',
        accentGlow: 'rgba(245, 158, 11, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(245, 158, 11, 0.22) 0%, rgba(217, 119, 6, 0.08) 100%)',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '🌑 Dark Pop',
        desc: 'Bad Guy to What Was I Made For — Billie Eilish dark alt-pop Gen Z anthems',
        tags: ['#BillieEilish', '#BadGuy', '#GenZ', '#AltPop', '#DarkPop'],
        accent: '#84cc16',
        accentGlow: 'rgba(132, 204, 22, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(132, 204, 22, 0.22) 0%, rgba(101, 163, 13, 0.08) 100%)',
      ...
      },
      {
        ...
        icon: '🎬',
        category: 'artist',
        energy: '🎵 Bollywood Duo',
        desc: 'The composer duo behind biggest Bollywood hits — unlimited filmy banger energy',
        tags: ['#VishalShekhar', '#BollywoodComposer', '#FilmScore', '#Hits'],
        accent: '#8b5cf6',
        accentGlow: 'rgba(139, 92, 246, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(139, 92, 246, 0.22) 0%, rgba(109, 40, 217, 0.08) 100%)',
        quote: '"The music that makes Bollywood feel alive…"',
      ...
      },
      {
        ...
        category: 'artist',
        energy: '⚡ Thunder',
        desc: 'Believer, Thunder, Demons, Enemy — Imagine Dragons cinematic anthems non-stop',
        tags: ['#ImagineDragons', '#Believer', '#Thunder', '#Demons', '#Enemy'],
        accent: '#f97316',
        accentGlow: 'rgba(249, 115, 22, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(249, 115, 22, 0.22) 0%, rgba(234, 88, 12, 0.08) 100%)',
        quote: '"I\'m a believer — first things first, I\'ma say all the words inside my head."',
      ...
      },
      {
        ...
        icon: '🎺',
        category: 'artist',
        energy: '🌏 Mozart of Madras',
        desc: 'Jai Ho to Roja — A.R. Rahman timeless compositions spanning 30+ years',
        tags: ['#ARRahman', '#JaiHo', '#OscarWinner', '#Mozart', '#Madras'],
        accent: '#0d9488',
        accentGlow: 'rgba(13, 148, 136, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(13, 148, 136, 0.22) 0%, rgba(15, 118, 110, 0.08) 100%)',
        quote: '"Jai Ho — khuda ne sunli meri dua…"',
      ...
      },
      {
        ...
        icon: '🔥',
        category: 'artist',
        energy: '🎉 OG Party Starter',
        desc: 'The OG desi hip-hop king — Blue Eyes, Angreji Beat, party-starting anthems',
        tags: ['#HoneySingh', '#BlueEyes', '#Desi', '#OG', '#AngreiziBeaat'],
        accent: '#7c3aed',
        accentGlow: 'rgba(124, 58, 237, 0.45)',
        gradient: 'linear-gradient(135deg, rgba(124, 58, 237, 0.22) 0%, rgba(109, 40, 217, 0.08) 100%)',
        quote: '"Main sharabi — aankh mili toh dil machalaa…"',
    ...
    function playMoodStation(mood) {
      ...
      if (typeof STATION_TRACKS !== 'undefined') {
        var poolMap = {
          ...
          'artist': ['ishq', 'time-travel', 'demanding', '90s']
        };
  ...
  if ($('premiumMenuToggle') && $('premiumSidebarMenu') && $('closeSidebarBtn')) {
    ...
    var sbQueueBtn = $('sidebarQueueBtn');
    if (sbQueueBtn) {
      sbQueueBtn.addEventListener('click', function () {
        closeSidebar();
        toggleQueue();
      });
    }
  ...
  var sbVibeSpeedBtn = $('sidebarVibeSpeedBtn');
  if (sbVibeSpeedBtn) {
    sbVibeSpeedBtn.addEventListener('click', function (e) {
      e.stopPropagation();
      cycleSpeedMode();
    });
  }
