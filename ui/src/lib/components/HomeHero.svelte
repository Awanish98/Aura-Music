...
<div class="relative overflow-hidden rounded-3xl border border-slate-200/90 dark:border-pink-500/30 bg-gradient-to-r from-white via-pink-50/60 to-purple-50/70 dark:from-[#0c0e1e]/95 dark:via-[#151028]/90 dark:to-[#220d2c]/85 p-6 sm:p-8 shadow-md dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] mb-8 select-none backdrop-blur-3xl group">
	...
	<div class="pointer-events-none absolute -right-16 -top-16 h-80 w-80 rounded-full bg-pink-500/15 dark:bg-pink-500/30 blur-3xl animate-pulse"></div>
	<div class="pointer-events-none absolute -left-16 -bottom-16 h-80 w-80 rounded-full bg-purple-500/10 dark:bg-purple-600/25 blur-3xl"></div>
	<div class="pointer-events-none absolute left-1/3 top-1/4 h-64 w-64 rounded-full bg-cyan-500/10 dark:bg-cyan-500/20 blur-3xl"></div>
	...
	<div class="pointer-events-none absolute right-0 top-0 bottom-0 w-full sm:w-3/5 lg:w-1/2 overflow-hidden opacity-25 dark:opacity-85 mix-blend-multiply dark:mix-blend-screen transition-transform duration-1000 group-hover:scale-102">
		...
		/>
		<div class="absolute inset-0 bg-gradient-to-r from-white via-white/80 to-transparent dark:from-[#0c0e1e] dark:via-[#0c0e1e]/60 dark:to-transparent"></div>
		<div class="absolute inset-0 bg-gradient-to-t from-white/90 via-transparent to-transparent dark:from-[#0c0e1e]/80 dark:via-transparent dark:to-transparent"></div>
	</div>
	...
	<div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
		...
		<div class="flex-1 space-y-1.5 max-w-lg">
			...
			<p class="text-sm sm:text-base text-slate-600 dark:text-purple-200/90 font-medium tracking-wide">
